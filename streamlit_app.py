...
col1.title("VAA - MSME bot demo.")
col1.markdown("<div class='small-header'> Ideate & Explore !</div>", unsafe_allow_html=True)
...
initial_prompt = "Assistant: Brief me about your intention, please."
